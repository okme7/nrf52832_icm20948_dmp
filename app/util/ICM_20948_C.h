...
#define INV_MAX_SERIAL_WRITE 16
  ...
  typedef enum
  {
    ...
    ICM_20948_Stat_FIFONoDataAvail,    // FIFO contains no data       10
    ICM_20948_Stat_FIFOIncompleteData, // FIFO contained incomplete data 11
    ICM_20948_Stat_FIFOMoreDataAvail,  // FIFO contains more data     12
