...
extern "C"
{
  ...
  typedef enum
  {
    ...
    AGB0_REG_FIFO_CFG,
    // Break
    AGB0_REG_MEM_START_ADDR = 0x7C, // Hmm, Invensense thought they were sneaky not listing these locations on the datasheet...  Ð´Èë»ò¶ÁÈ¡µÄµØÖ·
    AGB0_REG_MEM_R_W = 0x7D,        // These three locations seem to be able to access some memory within the device    ¶ÁÐ´¼Ä´æÆ÷
    AGB0_REG_MEM_BANK_SEL = 0x7E,   // And that location is also where the DMP image gets loaded      ÄÚ´æ²å²ÛÑ¡Ôñ
